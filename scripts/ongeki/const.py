...
def update_const_data():
    ...
    if total_diffs[0] == 0:
        ...
        columns = ['ID', 'Title', 'BAS', 'ADV', 'EXP', 'MAS', 'LNT']
    ...
    for [chart, chart_diff] in CHARTS:
        ...
        if value_chart_i is not None:
            ...
            # If value is valid
                ...
                col_diff = diff_map.get(chart_diff, chart_diff)
                ...
                if is_empty:
                    ...
                    if change_data is not None:
                        ...
                        change_data['rows'][song['id']]['diffs'][col_diff] = str(value_chart_i)
                    ...
                    if song[key_chart_i] != str(value_chart_i):
                        if game.ARGS.overwrite:
                            ...
                            if change_data is not None:
                                ...
                                change_data['rows'][song['id']]['diffs'][col_diff] = f"~~{song[key_chart_i]}~~ → {value_chart_i}"
